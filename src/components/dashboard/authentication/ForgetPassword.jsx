...
const ForgetPassword = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (!response.ok) {
                setError(data.message || 'Algo salió mal, por favor intenta nuevamente.');
            } else {
                setSuccess('Por favor revisa tu correo electrónico para el enlace de recuperación.');
                // Opcional: redirigir al usuario después del éxito
                // navigate('/authentication/sign-in');
            }
        } catch (error) {
            console.error('Hubo un problema con tu solicitud de recuperación de contraseña:', error);
            setSuccess('Por favor revisa tu correo electrónico para el enlace de recuperación.');
        }
    };
